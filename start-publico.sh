#!/bin/bash
# =============================================================
# app-publico-vite - Kill & Start (porta 3002)
# =============================================================

SCRIPT_DIR="$(cd "$(dirname "$0")" && pwd)"
FRONTEND_DIR="$SCRIPT_DIR/app-publico-vite"
PORT=3002
LOG="/tmp/app-publico-vite.log"
...
echo ""
echo -e "${BOLD}${CYAN}app-publico-vite${NC} - porta ${BOLD}$PORT${NC}"
echo ""
...
echo -e "    Armario:    ${CYAN}http://$LOCAL_IP:$PORT/p/armario/149${NC}"
echo ""

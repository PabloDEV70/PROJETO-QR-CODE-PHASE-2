#!/bin/bash
# =============================================================
# app-painel-veiculos-vite - Kill & Start (porta 3008)
# Painel de veiculos
# =============================================================

SCRIPT_DIR="$(cd "$(dirname "$0")" && pwd)"
FRONTEND_DIR="$SCRIPT_DIR/app-painel-veiculos-vite"
PORT=3008
LOG="/tmp/app-painel-veiculos-vite.log"
...
echo ""
echo -e "${BOLD}${CYAN}app-painel-veiculos-vite${NC} - porta ${BOLD}$PORT${NC}"
echo ""

#!/bin/bash
# =============================================================
# app-quadro-vite - Kill & Start (porta 3012)
# =============================================================

SCRIPT_DIR="$(cd "$(dirname "$0")" && pwd)"
FRONTEND_DIR="$SCRIPT_DIR/app-quadro-vite"
PORT=3012
LOG="/tmp/app-quadro-vite.log"
...
echo ""
echo -e "${BOLD}${CYAN}app-quadro-vite${NC} - porta ${BOLD}$PORT${NC}"
echo ""

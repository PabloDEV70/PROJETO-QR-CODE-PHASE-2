...
import { useRdoTimeline } from './use-rdo-analytics';
 ...
 */
export function useWrenchTimeTrend(filterParams: Record<string, string | number>) {
  const timeline = useRdoTimeline(filterParams);

...
echo -e "    Nova Corrida:  ${CYAN}http://$LOCAL_IP:$PORT/nova-corrida${NC}"
echo -e "    Estatisticas:  ${CYAN}http://$LOCAL_IP:$PORT/estatisticas${NC}"
echo -e "    Motorista:     ${CYAN}http://$LOCAL_IP:$PORT/motorista${NC}"
echo ""

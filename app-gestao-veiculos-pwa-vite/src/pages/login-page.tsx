...
export default function AppLoginPage() {
  ...
  return (
    <SharedLoginPage
      appName="Gestao Veiculos"
      appSubtitle="Frota e manutencao"
      enableDbSelector
      enableTurnstile={!!(import.meta.env as Record<string, string>).VITE_TURNSTILE_SITE_KEY}
      turnstileSiteKey={(import.meta.env as Record<string, string>).VITE_TURNSTILE_SITE_KEY}
      database={database}

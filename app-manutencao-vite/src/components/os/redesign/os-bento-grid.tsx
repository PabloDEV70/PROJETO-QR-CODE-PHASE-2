      ...
      <Grid container spacing={6} sx={{ px: 3, py: 3 }}>
        ...
        <Grid item xs={12} md={4}>
          ...
          <Stack spacing={3}>
            <Grid container spacing={2}>
              <Grid item xs={6}><F label="PLACA" value={os.veiculo.placa} readOnly /></Grid>
              <Grid item xs={6}><F label="TAG" value={os.veiculo.tag} readOnly /></Grid>
            </Grid>
            <F label="MARCA / MODELO" value={os.veiculo.marca} readOnly />
            <Grid container spacing={2}>
              <Grid item xs={6}><F label="KM ENTRADA" value={os.KM} isNumeric /></Grid>
              <Grid item xs={6}><F label="HORÍMETRO" value={os.HORIMETRO} isNumeric /></Grid>
            </Grid>
          </Stack>
        </Grid>
        ...
        <Grid item xs={12} md={4}>
          ...
          <Stack spacing={3}>
            ...
            <Grid container spacing={2}>
              <Grid item xs={6}><F select label="ORIGEM (INT/EXT)" value={os.TIPO || ''} options={TIPO_OS_OPTIONS} /></Grid>
              <Grid item xs={6}><F select label="STATUS GIG" value={os.AD_STATUSGIG || ''} options={gigOpts} /></Grid>
            </Grid>
        ...
        <Grid item xs={12} md={4}>
          ...
          <Stack spacing={3}>
            <Grid container spacing={2}>
              <Grid item xs={6}><DT label="INÍCIO REAL" value={os.DATAINI} readOnly /></Grid>
              <Grid item xs={6}><DT label="FIM REAL" value={os.DATAFIN} readOnly /></Grid>
            </Grid>

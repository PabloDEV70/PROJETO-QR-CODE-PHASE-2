#!/bin/bash
# =============================================================
# app-gestao-veiculos-pwa-vite - Kill & Start (porta 3009)
# PWA de gestao de veiculos
# =============================================================

SCRIPT_DIR="$(cd "$(dirname "$0")" && pwd)"
FRONTEND_DIR="$SCRIPT_DIR/app-gestao-veiculos-pwa-vite"
PORT=3009
LOG="/tmp/app-gestao-veiculos-pwa-vite.log"
...
echo ""
echo -e "${BOLD}${CYAN}app-gestao-veiculos-pwa-vite${NC} - porta ${BOLD}$PORT${NC}"
echo ""

#!/bin/bash
# =============================================================
# app-chamados-vite - Kill & Start (porta 3004)
# =============================================================

SCRIPT_DIR="$(cd "$(dirname "$0")" && pwd)"
FRONTEND_DIR="$SCRIPT_DIR/app-chamados-vite"
PORT=3004
LOG="/tmp/app-chamados-vite.log"
...
echo ""
echo -e "${BOLD}${CYAN}app-chamados-vite${NC} - porta ${BOLD}$PORT${NC}"
echo ""
...
echo -e "    Chamados:   ${CYAN}http://$LOCAL_IP:$PORT/chamados${NC}"
echo -e "    Por Setor:  ${CYAN}http://$LOCAL_IP:$PORT/chamados/por-setor${NC}"
echo ""

#!/bin/bash
# =============================================================
# app-etiquetas-vite - Kill & Start (porta 3003)
# =============================================================

SCRIPT_DIR="$(cd "$(dirname "$0")" && pwd)"
FRONTEND_DIR="$SCRIPT_DIR/app-etiquetas-vite"
PORT=3003
LOG="/tmp/app-etiquetas-vite.log"
...
echo ""
echo -e "${BOLD}${CYAN}app-etiquetas-vite${NC} - porta ${BOLD}$PORT${NC}"
echo ""
...
echo -e "    Armarios:   ${CYAN}http://$LOCAL_IP:$PORT/armarios${NC}"
echo ""

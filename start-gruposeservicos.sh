#!/bin/bash
# =============================================================
# app-gruposeservicos-vite - Kill & Start (porta 3011)
# =============================================================

SCRIPT_DIR="$(cd "$(dirname "$0")" && pwd)"
FRONTEND_DIR="$SCRIPT_DIR/app-gruposeservicos-vite"
PORT=3011
LOG="/tmp/app-gruposeservicos-vite.log"
...
echo ""
echo -e "${BOLD}${CYAN}app-gruposeservicos-vite${NC} - porta ${BOLD}$PORT${NC}"
echo ""

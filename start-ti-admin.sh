#!/bin/bash
# =============================================================
# app-ti-admin-vite - Kill & Start (porta 3010)
# =============================================================

SCRIPT_DIR="$(cd "$(dirname "$0")" && pwd)"
FRONTEND_DIR="$SCRIPT_DIR/app-ti-admin-vite"
PORT=3010
LOG="/tmp/app-ti-admin-vite.log"
...
echo ""
echo -e "${BOLD}${CYAN}app-ti-admin-vite${NC} - porta ${BOLD}$PORT${NC}"
echo ""
...
echo -e "    Usuarios:    ${CYAN}http://$LOCAL_IP:$PORT/usuarios${NC}"
echo -e "    Comparar:    ${CYAN}http://$LOCAL_IP:$PORT/comparar${NC}"
echo -e "    Investigar:  ${CYAN}http://$LOCAL_IP:$PORT/investigar${NC}"
echo ""

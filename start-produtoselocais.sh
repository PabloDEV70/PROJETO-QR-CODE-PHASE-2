#!/bin/bash
# =============================================================
# app-produtoselocais-vite - Kill & Start (porta 3013)
# =============================================================

SCRIPT_DIR="$(cd "$(dirname "$0")" && pwd)"
FRONTEND_DIR="$SCRIPT_DIR/app-produtoselocais-vite"
PORT=3013
LOG="/tmp/app-produtoselocais-vite.log"
...
echo ""
echo -e "${BOLD}${CYAN}app-produtoselocais-vite${NC} - porta ${BOLD}$PORT${NC}"
echo ""

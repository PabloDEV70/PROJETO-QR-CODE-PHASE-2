...
export function useMeusRdos(params: UseMeusRdosParams = {}) {
  ...
  return useQuery({
    ...
    queryFn: () => getMeusRdos({ codparc, dataInicio: params.dataInicio, dataFim: params.dataFim }),
    enabled: !!codparc,
    ...CACHE_TIMES.rdoList,
  });
}
...
export function useMeusRdosInfinite(params: UseMeusRdosParams = {}) {
  ...
  return useInfiniteQuery({
    ...
    queryFn: ({ pageParam = 1 }) =>
      getMeusRdos({ codparc, page: pageParam, limit: PAGE_SIZE, dataInicio: params.dataInicio, dataFim: params.dataFim }),
    initialPageParam: 1,
